...
public class CustomerPanelController {
	...
	// Add a public no-args constructor
	 ...
	 public void showRest(ActionEvent event) throws IOException {
	 ...
	 public void feedback(ActionEvent event) throws IOException {
		  ...
		  FXMLLoader loader = new FXMLLoader();
			Stage currentStage=(Stage)((Node)event.getSource()).getScene().getWindow();
			String fxmlDocPath = "src/application/feedback.fxml";
			FileInputStream fxmlStream = new FileInputStream(fxmlDocPath);
			AnchorPane pane = (AnchorPane) loader.load(fxmlStream);
			System.out.println("\n 0- "+loader.getController().getClass().getName()+"\n");
			feedbackController obj= loader.getController();
			System.out.println("\n 1- "+loader.getController().getClass().getName()+"\n");
			obj.setController(controller);
			Scene scene = new Scene(pane,600,600);
			currentStage.setScene(scene);
			currentStage.show();
	 ...
	 public void ChangeInfo(ActionEvent event) throws IOException {
		 	...
		 	FXMLLoader loader = new FXMLLoader();
			Stage currentStage=(Stage)((Node)event.getSource()).getScene().getWindow();
			String fxmlDocPath = "src/application/ChangeCustomerInfo.fxml";
			FileInputStream fxmlStream = new FileInputStream(fxmlDocPath);
			AnchorPane pane = (AnchorPane) loader.load(fxmlStream);
			System.out.println("\n 2- "+loader.getController().getClass()+"\n");
			ChangeCustomerInfoController obj= loader.getController();
			obj.setController(controller);
